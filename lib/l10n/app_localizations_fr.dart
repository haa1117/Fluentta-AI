...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get sendVerificationCode => 'Envoyer le lien';
  ...
  String get checkResetEmailInstructions =>
      'Ouvrez votre email et touchez le lien. L\'application s\'ouvrira pour définir un nouveau mot de passe.';
  ...
  @override
  String get levelUpperIntermediateSub => 'B2 · Interaction fluide';

  @override
  String get levelAdvancedC1 => 'Avancé';

  @override
  String get levelAdvancedC1Sub => 'C1 · Exprime des idées avec aisance';

  @override
  String get levelProficientC2 => 'Compétent';

  @override
  String get levelProficientC2Sub => 'C2 · Maîtrise quasi native';
  ...
  String learnPathEarnXp(int count, int xp) {
    return 'Apprenez $count leçons et gagnez +$xp XP';
  }
  ...
  String focusOnSounds(String sounds) {
    return 'Concentrez-vous sur : $sounds';
  }

  @override
  String youSaid(String transcript) {
    return 'Vous avez dit : \"$transcript\"';
  }

  @override
  String get noSpeechDetected =>
      'Nous n\'avons pas détecté une voix claire. Parlez plus fort et réessayez.';
  ...
  String get pronunciationUnavailable =>
      'Le micro ou la reconnaissance vocale n\'est pas disponible sur cet appareil.';

  @override
  String get microphonePermissionDenied =>
      'L\'autorisation du micro est requise pour la prononciation.';
  ...
  String notQuiteCorrectAnswer(String answer) {
    return 'Pas tout à fait. La bonne réponse est : $answer';
  }

  @override
  String get practiceLabel => 'Entraînement';

  @override
  String get yourAnswerHint => 'Votre réponse';
  ...
  @override
  String get whatsUnlockedTitle => 'Ce que vous avez débloqué';
  ...
  String get nothingUnlockedYet =>
      'Continuez à apprendre pour débloquer des niveaux et des scénarios de jeu de rôle !';

  @override
  String nextUnlockLabel(String label, int xp) {
    return 'Suivant : $label — $xp XP restants';
  }

  @override
  String watchAdForXpSub(int xp) {
    return 'Obtenez +$xp XP instantanément';
  }
