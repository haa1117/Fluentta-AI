...
import 'package:fluentta_ai/viewmodels/roleplay_vocabulary_view_model.dart';
...
class RoleplayVocabularyPathScreen extends StatelessWidget {
  const RoleplayVocabularyPathScreen({super.key, required this.scenarioId});
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => RoleplayVocabularyViewModel(
        scenarioId,
        context.read(),
        context.read(),
        context.read(),
      ...
      child: Consumer<RoleplayVocabularyViewModel>(
